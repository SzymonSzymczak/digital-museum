...
export const materialModule = (function () {
	...
	const ceilingMaterial = (x, y) => {
		...
		texture.wrapT = THREE.RepeatWrapping;
		texture.repeat.set(x, y);
		return new THREE.MeshLambertMaterial({ map: texture, color: '#E7E7DD' });
	};
	...
	return { Amenemhat_iii_0: Amenemhat_iii_0, Amenemhat_iii_1: Amenemhat_iii_1, floorMaterial: floorMaterial, wallMaterial: wallMaterial, ceilingMaterial: ceilingMaterial, columnMaterial: columnMaterial };
})();
